...
abstract class CandidateFeature2TestBase {

    protected static final String VALID_TOKEN = "valid-candidate-token";
    protected static final String INVALID_TOKEN = "invalid-token";
    protected static final String TEST_EMAIL = "dupk0207@ut.edu.vn";
    ...
    @Mock
    protected CandidateCVRepository cvRepository;

    protected MockMvc profileMvc;
    protected MockMvc cvMvc;
    ...
    protected boolean authHeaderIsValid(String authHeader) {
    ...
    protected CandidateProfileResponse sampleProfile() {
        return sampleProfileWithSkills(List.of("Java", "Spring Boot"));
    }

    protected CandidateProfileResponse sampleProfileWithSkills(List<String> skills) {
    ...
    protected CandidateCV sampleCV(Long id, User owner, String title) {
    ...
    protected String profilePayload(List<String> skills, String aboutMe) throws Exception {
    ...
    protected String cvPayload(String title, String templateType) throws Exception {
...
class CandidateFeature2CoreTest extends CandidateFeature2TestBase {
